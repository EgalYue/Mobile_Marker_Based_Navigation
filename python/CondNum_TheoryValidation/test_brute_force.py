...
def Z_fixed_study_XY():
    ...
    #------------For 1 End-------------------------------------------------
    inputX, inputY, inputZ, input_ippe1_t, input_ippe1_R, input_ippe2_t, input_ippe2_R, input_pnp_t, input_pnp_R, input_transfer_error = bf.heightGetCondNum(cams_Zfixed)
...
def XY_fixed_study_Z():
    ...
    inputX, inputY, inputZ, input_ippe1_t, input_ippe1_R, input_ippe2_t, input_ippe2_R, input_pnp_t, input_pnp_R, input_transfer_error = bf.heightGetCondNum(cams_XYfixed)
...
def Z_fixed_study_square():
    ...
    inputX, inputY, inputZ, input_ippe1_t, input_ippe1_R, input_ippe2_t, input_ippe2_R, input_pnp_t, input_pnp_R, input_transfer_error = bf.heightGetCondNum(cams_HeightFixed)

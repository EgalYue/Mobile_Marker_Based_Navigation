...
def main():
    ...
    fix_pathMat_list.append(p12)
    fix_pathMat_list.append(p13)
    fix_pathMat_list.append(p14)
    fix_pathMat_list.append(p15)

    fix_pathMat_list.append(p16)
    fix_pathMat_list.append(p17)
    fix_pathMat_list.append(p18)
    fix_pathMat_list.append(p19)
    fix_pathMat_list.append(p20)
    fix_pathMat_list.append(p21)
    fix_pathMat_list.append(p22)
    fix_pathMat_list.append(p23)
